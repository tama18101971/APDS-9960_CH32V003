...
/* ============================================================================
 * USER CALLBACK — вызывается из дефолтного EXTI7_0_IRQHandler
 *
 * Переопределите эту функцию в своём коде, чтобы обработать
 * другие EXTI линии (0-7 делят один вектор на CH32V003).
 * ============================================================================ */
